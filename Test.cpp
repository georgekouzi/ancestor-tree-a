...
t.addMother("ben", "shani");
    ...
    CHECK(t.getNode()->mother->mother->father->mother->name=="shani");
...
TEST_CASE("Test rlation"){  
    ...
    CHECK(t.relation(" ...") =="unrelated");
    CHECK(t.relation("             ") =="unrelated");
    CHECK(t.relation("tamar") =="great-grandmother");
    CHECK(t.relation("sigal") =="great-great-grandmother");
    CHECK(t.relation("gon") =="great-great-grandfather");
    CHECK(t.relation("tal") =="great-great-great-grandmother");        CHECK(t.relation(" ") =="unrelated");
    CHECK(t.relation("dfdv") =="unrelated");
    CHECK(t.relation("fdd") =="unrelated");
    CHECK(t.relation("ben") =="great-great-great-grandfather");
    CHECK(t.relation("shani") =="great-great-great-great-grandmother");
    CHECK(t.relation(" ") =="unrelated");
...
t.remove("doron");
    CHECK("unrelated"==t.relation("dor") );    
